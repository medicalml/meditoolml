...
def normal(x, mean, standard_deviation):
    ...
    Args:
        x: Int or float or list of ints or floats representing values for which the normal distribution density is desired.
